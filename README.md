...
<p align="center">
  <a href="https://hub.docker.com/r/mekayelanik/branch-thinking-mcp"><img alt="Docker Pulls" src="https://img.shields.io/docker/pulls/mekayelanik/branch-thinking-mcp?style=flat-square&logo=docker"></a>
  <a href="https://hub.docker.com/r/mekayelanik/branch-thinking-mcp"><img alt="Docker Stars" src="https://img.shields.io/docker/stars/mekayelanik/branch-thinking-mcp?style=flat-square&logo=docker"></a>
  <a href="https://github.com/mekayelanik/branch-thinking-mcp-docker/pkgs/container/branch-thinking-mcp"><img alt="GHCR" src="https://img.shields.io/badge/GHCR-ghcr.io%2Fmekayelanik%2Fbranch-thinking-mcp-blue?style=flat-square&logo=github"></a>
  <a href="https://github.com/mekayelanik/branch-thinking-mcp-docker/blob/main/LICENSE"><img alt="License: GPL-3.0" src="https://img.shields.io/badge/License-GPL--3.0-blue?style=flat-square"></a>
  <a href="https://hub.docker.com/r/mekayelanik/branch-thinking-mcp"><img alt="Platforms" src="https://img.shields.io/badge/Platforms-amd64%20%7C%20arm64-lightgrey?style=flat-square"></a>
  <a href="https://github.com/MekayelAnik/branch-thinking-mcp-docker/stargazers"><img alt="GitHub Stars" src="https://img.shields.io/github/stars/MekayelAnik/branch-thinking-mcp-docker?style=flat-square"></a>
  <a href="https://github.com/MekayelAnik/branch-thinking-mcp-docker/forks"><img alt="GitHub Forks" src="https://img.shields.io/github/forks/MekayelAnik/branch-thinking-mcp-docker?style=flat-square"></a>
  <a href="https://github.com/MekayelAnik/branch-thinking-mcp-docker/issues"><img alt="GitHub Issues" src="https://img.shields.io/github/issues/MekayelAnik/branch-thinking-mcp-docker?style=flat-square"></a>
  <a href="https://github.com/MekayelAnik/branch-thinking-mcp-docker/commits/main"><img alt="Last Commit" src="https://img.shields.io/github/last-commit/MekayelAnik/branch-thinking-mcp-docker?style=flat-square"></a>
</p>

### Multi-Architecture Docker Image for Parallel Reasoning & Exploration

<div align="left">

<img alt="branch-thinking-mcp" src="https://img.shields.io/badge/Branch Thinking-MCP-00E9A3?style=for-the-badge&logo=data:image/svg+xml;base64,&logoColor=white" width="400">

[![Docker Pulls](https://img.shields.io/docker/pulls/mekayelanik/branch-thinking-mcp.svg?style=flat-square)](https://hub.docker.com/r/mekayelanik/branch-thinking-mcp)
[![Docker Stars](https://img.shields.io/docker/stars/mekayelanik/branch-thinking-mcp.svg?style=flat-square)](https://hub.docker.com/r/mekayelanik/branch-thinking-mcp)
[![License](https://img.shields.io/badge/license-GPL-blue.svg?style=flat-square)](https://raw.githubusercontent.com/MekayelAnik/branch-thinking-mcp-docker/refs/heads/main/LICENSE)

**[Official Website](https://github.com/nicholasgriffintn/branch-thinking-mcp/)** • **[Documentation](https://github.com/nicholasgriffintn/branch-thinking-mcp)** • **[Docker Hub](https://hub.docker.com/r/mekayelanik/branch-thinking-mcp)**
...
Branch Thinking MCP Server provides parallel reasoning and multi-path exploration capabilities through the Model Context Protocol. Built for structured decision-making and complex problem solving.
...
services:
  branch-thinking-mcp:
    image: mekayelanik/branch-thinking-mcp:stable
    container_name: branch-thinking-mcp
...
```bash
docker compose up -d
docker compose logs -f branch-thinking-mcp
```
...
docker run -d \
  ...
  mekayelanik/branch-thinking-mcp:stable
```
...
```bash
docker pull mekayelanik/branch-thinking-mcp:stable
docker stop branch-thinking-mcp && docker rm branch-thinking-mcp
...
# Check logs
docker logs branch-thinking-mcp
```
...
# Verify container
docker inspect branch-thinking-mcp | grep IPAddress
```

#### Slow ARM Performance

- Wait 30-60 seconds after start
- Monitor: `docker logs -f branch-thinking-mcp`
- Check resources: `docker stats branch-thinking-mcp`
...
# Container logs
docker logs branch-thinking-mcp --tail 200 > logs.txt

# Container config
docker inspect branch-thinking-mcp > inspect.json
```
...
### Documentation
- 📚 [Branch Thinking Official Docs](https://github.com/nicholasgriffintn/branch-thinking-mcp)
- 📦 [NPM Package](https://www.npmjs.com/package/branch-thinking-mcp)
...
**Docker Image Issues:**
- GitHub: [branch-thinking-mcp-docker/issues](https://github.com/MekayelAnik/branch-thinking-mcp/issues)

**Branch Thinking MCP Issues:**
- GitHub: [nicholasgriffintn/branch-thinking-mcp/issues](https://github.com/nicholasgriffintn/branch-thinking-mcp/issues)
- Website: [github.com/nicholasgriffintn/branch-thinking-mcp](https://github.com/nicholasgriffintn/branch-thinking-mcp/)
...
GPL License. See [LICENSE](https://raw.githubusercontent.com/MekayelAnik/branch-thinking-mcp-docker/refs/heads/main/LICENSE) for details.

Branch Thinking MCP server has its own license - see [Main NPM repo](https://github.com/nicholasgriffintn/branch-thinking-mcp).
...
[⬆ Back to Top](#branch-thinking-mcp-server)
